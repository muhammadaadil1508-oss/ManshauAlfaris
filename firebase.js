// Firebase SDK (CDN ES Modules for browser environment)
...
// Export additional helpers for convenient access across components
export { app, analytics, ref, set, get, push, onValue, child, update, remove };
